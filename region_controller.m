...
% w_s saturation term
xe=forward_kinematics(q);                                    %da fare (adattare funzione matlab in questa)  %forward kinematics 
...
A=transition_matrix(xe,xdes,w);                              %da fare (problemi con derivata)  % transition matrix A
...
J=jacobian(q);                                               %da fare (adattare funzione matlab in questa)   % Jacobian   
